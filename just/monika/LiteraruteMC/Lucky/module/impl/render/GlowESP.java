...
import just.monika.LiteraruteMC.Lucky.utils.render.ESPUtil;
...
public class GlowESP extends Module {
    ...
    private final ColorSetting glowColor = new ColorSetting("Glow Color", LuckyClient.INSTANCE.getClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("LuckyClient/Shaders/outline.frag");
    private final ShaderUtil glowShader = new ShaderUtil("LuckyClient/Shaders/glow.frag");
