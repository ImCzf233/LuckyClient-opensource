...
import just.monika.LiteraruteMC.Lucky.event.impl.render.NametagRenderEvent;
...
import just.monika.LiteraruteMC.Lucky.utils.render.*;
...
public class ESP2D extends Module {
    ...
    private final ModeSetting boxColorMode = new ModeSetting("Box Mode", "Sync", "Sync", "LuckyClient", "Light Rainbow", "Rainbow", "Static", "Fade", "Double Color", "Analogous");
        ...
        if (boxEsp.isEnabled()) {
            switch (boxColorMode.getMode()) {
                case "Sync":
                    ...
                    break;
                case "LuckyClient":
                    firstColor = ColorUtil.interpolateColorsBackAndForth(15, 0, LuckyClient.INSTANCE.getClientColor(), LuckyClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                    secondColor = ColorUtil.interpolateColorsBackAndForth(15, 90, LuckyClient.INSTANCE.getClientColor(), LuckyClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                    thirdColor = ColorUtil.interpolateColorsBackAndForth(15, 180, LuckyClient.INSTANCE.getClientColor(), LuckyClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                    fourthColor = ColorUtil.interpolateColorsBackAndForth(15, 270, LuckyClient.INSTANCE.getClientColor(), LuckyClient.INSTANCE.getAlternateClientColor(), HudMod.hueInterpolation.isEnabled());
                    break;
                case "Light Rainbow":
