...
import just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.backend.KingGenApi;
import just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.Component;
import just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button;
import just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.StringField;
...
public class KingAltsPanel implements AltPanel {
    private final KingGenApi kingGenApi = null;//= LuckyClient.INSTANCE.kingGenApi;
    public Animation errorAnimation;
    public Animation hasKingAltKey;
    ArrayList<just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.Component> components = new ArrayList<just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.Component>() {{
        addAll(Arrays.asList(
                new StringField("Enter your KingAlts key", 230, 250, true),
                new just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button("Submit Key", 230, 30, 250),
                new just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button("Reset Key", 105, 30),
                new just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button("Refresh API", 105, 30),
                new just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button("Gen and Login", 105, 30)
        ));
    }};
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks, Animation initAnimation) {
        ...
        ((just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button) components.get(1)).textColor =
        ...
        ((just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button) components.get(2)).alternateAnimation = hasKingAltKey;

        //Refresh button
        components.get(3).x = 30;
        components.get(3).y = 270;
        ((just.monika.LiteraruteMC.Lucky.ui.oldaltmanager.panels.components.impl.Button) components.get(3)).alternateAnimation = hasKingAltKey;
