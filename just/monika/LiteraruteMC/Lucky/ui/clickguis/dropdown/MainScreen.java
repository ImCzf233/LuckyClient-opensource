...
import just.monika.LiteraruteMC.Lucky.ui.clickguis.dropdown.impl.ModuleRect;
...
import static just.monika.LiteraruteMC.Lucky.utils.misc.HoveringUtil.isHovering;
...
public class MainScreen implements Screen {
    ...
    public void initGui() {
        if (moduleRects == null) {
            ...
            for (Module module : LuckyClient.INSTANCE.getModuleCollection().getModulesInCategory(category).stream().sorted(Comparator.comparing(Module::getName)).collect(Collectors.toList())) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        ClickGuiMod clickGUIMod = (ClickGuiMod) LuckyClient.INSTANCE.getModuleCollection().get(ClickGuiMod.class);
