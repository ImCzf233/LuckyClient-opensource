...
public class GradientUtil implements Utils {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("LuckyClient/Shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("LuckyClient/Shaders/gradient.frag");
