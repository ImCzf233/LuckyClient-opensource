...
import just.monika.LiteraruteMC.Lucky.subclient.rose.Client;
import just.monika.LiteraruteMC.Lucky.subclient.rose.EnterScreen;
...
import just.monika.LiteraruteMC.Lucky.ui.SplashScreen;
...
import just.monika.LiteraruteMC.Lucky.event.impl.player.BlockEvent;
import just.monika.LiteraruteMC.Lucky.event.impl.player.ClickEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage { //Lol
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        FontUtil.tenacityFont22_ = FontUtil.getFont(locationMap, "tenacity.ttf", 22);
        FontUtil.tenacityFont22 = new MinecraftFontRenderer(FontUtil.tenacityFont22_);
        FontUtil.iconFont40_ = FontUtil.getFont(locationMap, "check.ttf", 40);
        FontUtil.iconFont40 = new MinecraftFontRenderer(FontUtil.iconFont40_);
        FontUtil.tenacityFont20_ = FontUtil.getFont(locationMap, "tenacity.ttf", 20);
        FontUtil.tenacityFont20 = new MinecraftFontRenderer(FontUtil.tenacityFont20_);
        FontUtil.tenacityBoldFont20_ = FontUtil.getFont(locationMap, "tenacitybold.ttf", 20);
        FontUtil.tenacityBoldFont20 = new MinecraftFontRenderer(FontUtil.tenacityBoldFont20_);
        FontUtil.tenacityFont14_ = FontUtil.getFont(locationMap, "tenacity.ttf", 14);
        FontUtil.tenacityFont14 = new MinecraftFontRenderer(FontUtil.tenacityFont14_);
        FontUtil.tenacityBoldFont26_ = FontUtil.getFont(locationMap, "tenacitybold.ttf", 26);
        FontUtil.tenacityBoldFont26 = new MinecraftFontRenderer(FontUtil.tenacityBoldFont26_);
        FontUtil.iconFont20_ = FontUtil.getFont(locationMap, "check.ttf", 20);
        FontUtil.iconFont20 = new MinecraftFontRenderer(FontUtil.iconFont20_);
        FontUtil.tenacityBoldFont18_ = FontUtil.getFont(locationMap, "tenacitybold.ttf", 18);
        FontUtil.tenacityBoldFont18 = new MinecraftFontRenderer(FontUtil.tenacityBoldFont18_);
        FontUtil.tenacityFont18_ = FontUtil.getFont(locationMap, "tenacity.ttf", 18);
        FontUtil.tenacityFont18 = new MinecraftFontRenderer(FontUtil.tenacityFont18_);
        FontUtil.tenacityFont16_ = FontUtil.getFont(locationMap, "tenacity.ttf", 16);
        FontUtil.tenacityFont16 = new MinecraftFontRenderer(FontUtil.tenacityFont16_);
        FontUtil.iconFont26_ = FontUtil.getFont(locationMap, "check.ttf", 26);
        FontUtil.iconFont26 = new MinecraftFontRenderer(FontUtil.iconFont26_);
        FontUtil.tenacityBoldFont22_ = FontUtil.getFont(locationMap, "tenacitybold.ttf", 22);
        FontUtil.tenacityBoldFont22 = new MinecraftFontRenderer(FontUtil.tenacityBoldFont22_);
        FontUtil.iconFont35_ = FontUtil.getFont(locationMap, "check.ttf", 35);
        FontUtil.iconFont35 = new MinecraftFontRenderer(FontUtil.iconFont35_);
        FontUtil.tenacityBoldFont32_ = FontUtil.getFont(locationMap, "tenacitybold.ttf", 32);
        FontUtil.tenacityBoldFont32 = new MinecraftFontRenderer(FontUtil.tenacityBoldFont32_);
        ...
        LuckyClient.INSTANCE.getModuleCollection().init();
        try{
...
//        ProtectedLaunch.start(); TODO

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new EnterScreen(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(new EnterScreen());
        }
    ...
    public void shutdown() {
        Client.dispatchEvent(new GameCloseEvent());
        this.running = false;
    }
    ...
    /**
     * Called when user clicked the right mouse button (place)
     */
    ...
    public void runTick() throws IOException {
        Client.dispatchEvent(new TickEvent(ticks));
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Client.dispatchEvent(new KeyPressEvent(k));
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                Client.dispatchEvent(blockEvent);
