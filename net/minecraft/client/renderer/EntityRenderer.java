...
import just.monika.LiteraruteMC.Lucky.subclient.rose.ClientType;
import just.monika.LiteraruteMC.Lucky.LuckyClient;
import just.monika.LiteraruteMC.Lucky.event.impl.render.Render3DEvent;
import just.monika.LiteraruteMC.Lucky.module.impl.combat.Reach;
import just.monika.LiteraruteMC.Lucky.module.impl.player.ChestStealer;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            double d0;
            if(Client.client == ClientType.DOKI) {
                d0 = LuckyClient.INSTANCE.getModuleCollection().getModuleByName("Reach").isToggled()
                        ? Reach.dbReach
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                //if(LuckyClient.INSTANCE.getModuleCollection().getModuleByName("HitBox").cfgSettings.)
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            ...
            float f = this.mc.gameSettings.mouseSensitivity * 0.6F + 0.2F;
            float f1 = f * f * f * (ChestStealer.shouldFreeLook() ? 10.0F : 8.0F);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Client.dispatchEvent(new Render3DEvent(partialTicks));
