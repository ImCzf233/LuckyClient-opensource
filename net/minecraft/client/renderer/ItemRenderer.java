...
import just.monika.LiteraruteMC.Lucky.module.impl.render.Animations;
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (LuckyClient.INSTANCE.isToggled(Animations.class)) {
                                switch (Animations.modeSetting.getMode()) {
                                    case "Stella":
