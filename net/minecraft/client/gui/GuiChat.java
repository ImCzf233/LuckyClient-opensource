...
import just.monika.LiteraruteMC.Lucky.module.impl.render.ArraylistMod;
import just.monika.LiteraruteMC.Lucky.module.impl.render.HudMod;
import just.monika.LiteraruteMC.Lucky.module.impl.render.SpotifyMod;
...
public class GuiChat extends GuiScreen {
    ...
    SpotifyMod spotifyMod = (SpotifyMod) LuckyClient.INSTANCE.getModuleCollection().get(SpotifyMod.class);
    ...
    ArraylistMod arraylistMod = (ArraylistMod) LuckyClient.INSTANCE.getModuleCollection().get(ArraylistMod.class);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (spotifyMod != null && spotifyMod.isToggled()) {
            float spacing = 0;
