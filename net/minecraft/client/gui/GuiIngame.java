...
import just.monika.LiteraruteMC.Lucky.module.impl.render.BlurModule;
import just.monika.LiteraruteMC.Lucky.event.impl.render.Render2DEvent;
import just.monika.LiteraruteMC.Lucky.module.impl.render.ScoreboardMod;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        BlurModule blurModule = (BlurModule) LuckyClient.INSTANCE.getModuleCollection().get(BlurModule.class);
        ...
        LuckyClient.INSTANCE.getNotificationManager().drawNotifications(scaledresolution);
        ...
        GlStateManager.translate(0, -15 * GuiChat.openingAnimation.getOutput(), 0);
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            if (l1 > 8)
            {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, (float) (-4 - 15 * GuiChat.openingAnimation.getOutput()), l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        ...
        if (scoreobjective1 != null && LuckyClient.INSTANCE.isToggled(ScoreboardMod.class))
        {
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            float f = this.zLevel;
            this.zLevel = -90.0F;
            this.drawTexturedModalRect(i - 91, (float) (sr.getScaledHeight() - (22 + 15 * GuiChat.openingAnimation.getOutput())), 0, 0, 182, 22);
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, (float) (sr.getScaledHeight() - (22 + 15 * GuiChat.openingAnimation.getOutput())), 0, 22, 24, 22);
            this.zLevel = f;
            ...
            for (int j = 0; j < 9; ++j)
            {
                ...
                int l = (int) (sr.getScaledHeight() - (19 + 15 * GuiChat.openingAnimation.getOutput()));
    ...
    public void renderSelectedItem(ScaledResolution scaledRes)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            if (k > 0)
            {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.getFontRenderer().drawStringWithShadow(s, (float)i, (float) (j - 15 * GuiChat.openingAnimation.getOutput()), 16777215 + (k << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            // Line text
            this.getFontRenderer().drawString(s1, l1, k, 553648127, ScoreboardMod.textShadow.isEnabled());

            // Line number
            if (ScoreboardMod.redNumbers.isEnabled()) {
                String s2 = EnumChatFormatting.RED + "" + score1.getScorePoints();
                this.getFontRenderer().drawString(s2, l - this.getFontRenderer().getStringWidth(s2), k, 553648127, ScoreboardMod.textShadow.isEnabled());
            }
            ...
            if (j == collection.size())
            {
                ...
                this.getFontRenderer().drawString(s3, l1 + i / 2.0F - this.getFontRenderer().getStringWidth(s3) / 2.0F, k - this.getFontRenderer().FONT_HEIGHT, 553648127, ScoreboardMod.textShadow.isEnabled());
            }
        }
    }
