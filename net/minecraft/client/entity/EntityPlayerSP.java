...
import just.monika.LiteraruteMC.Lucky.event.impl.player.*;
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            MotionEvent motionEvent = new MotionEvent(
                    Event.Type.PRE, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            Client.dispatchEvent(motionEvent);
...
//        if (LuckyClient.INSTANCE.getCommandHandler().execute(message) || message.startsWith(CommandHandler.CHAT_PREFIX)) {
//            return;
//        }
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Client.dispatchEvent(pushOutOfBlockEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            Client.dispatchEvent(slowDownEvent);
    ...
    public void jump() {
        ...
        Client.dispatchEvent(jumpEvent);
